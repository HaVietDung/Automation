...
public class CompareComponent {
    ...
    public static final List<WebElement> listProduct = getDriver().findElements(By.xpath("\"//li[@class=\\\"c-product-list__item productcollection__item\"]//a[@class='cmp-button c-button default  m-medium w-medium  c-button--default ']\""));
