...
public class CompareComponent {
    ...
    public List<WebElement> listProductInCategory = getDriver().findElements(By.xpath("(//li[@class='c-product-list__item productcollection__item'])["+i+"]"));
    public static final Target product = Target.the("Product").locatedBy("//li[@class=\"c-product-list__item productcollection__item\"][1]//a[@class='cmp-button c-button default  m-medium w-medium  c-button--default ']");
